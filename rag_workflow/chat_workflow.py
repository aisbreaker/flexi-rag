...
All the complex/hierarchical logic and data structures are encapsulated in this node.
"""
...
def create_workflow():
    ...
    # Define the node(s) - they contain the actual logic
    workflow.add_node("generate_chat_answer", generate_chat_answer_node)
